...
import { LayoutDashboard, Ship, Settings, LogOut, Menu } from 'lucide-react';
            ...
            <nav className="flex-1 space-y-2">
                {menuItems.map((item) => (
                    <button
                        ...
                        className={`w-full flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-300 ${active === item.name
